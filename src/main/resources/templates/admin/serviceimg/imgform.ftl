...
<body>
<form name="form" id="form" action="${ctx!}/admin/service/multipleImageUpload" method="post" enctype="multipart/form-data">
    ...
    <input type="text" name="serviceid" id="serviceid" value="${serviceid}">
</form>
<div id="onLoadImage">
...
<script type="text/javascript">
    ...
    function checkSubmit() {
        if(curFiles.length>0){
            ...
            $.ajax({
                url: '${ctx!}/admin/service/multipleImageUpload',
                type: 'post',
                data: formdata,
                processData: false,
                contentType: false,
