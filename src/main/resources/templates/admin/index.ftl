            ...
            <ul class="nav" id="side-menu">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">按摩店</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">按摩店
                    </div>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <@shiro.hasPermission name="system:user:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/customer/index">全部顾客</a>
                            </li>
                        </@shiro.hasPermission>
                        <@shiro.hasPermission name="system:user:index">
                            <li>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <@shiro.hasPermission name="system:user:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/massager/index">技师管理</a>
                            </li>
                        </@shiro.hasPermission>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <@shiro.hasPermission name="system:user:index">
                            <li>
                                <a class="J_menuItem" href="${ctx!}/admin/user/index">评价管理</a>
                            </li>
                        </@shiro.hasPermission>
                    </ul>
                </li>
